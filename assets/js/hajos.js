...
function handleButtonClicked(event) {
  ...
  innerModal.innerHTML = `
        ...
        <div class="row grid ">
                ...
                <div id="morepicture" class="col-lg-12 col-md-12 grid-item row cards" >
    ...
    <div class="sticky container modal-footer ">
    <div class="col-12 col-md-6 justify-content-center d-flex"><a class=" btn-custom primary justify-content-center" href="${hajos[description].page}" target="_blank" >${hajos[description].winery}</a></div>
...
`;
  ...
  let numberOfPictures = [...hajos[description].kepek];
  let morePictures = "";
  // let articlediv;
  // let underdiv;
  // let divimages;

  numberOfPictures.forEach(pictureFunction);
  document.getElementById("morepicture").innerHTML = morePictures;

  function pictureFunction(item, index) {
    morePictures += `
        <article class="post col-6  sigma_featured-product">
      <div class="post-thumbnail card" >
          <a href="#"><img class="lazyload jsimages" src="${item}" alt="blog post" /></a>
      </div>
  </article> `;
  }

  // for (let i = 0; i < numberOfPictures.length; i++) {
  //     extraPictures.innerHTML = `<article class="post col-12 col-md-6 sigma_featured-product">
  //           <div class="post-thumbnail card" data-description="4">
  //               <a href="#"><img class="lazyload jsimages" src="${numberOfPictures[i]}" alt="blog post" /></a>
  //           </div>
  //       </article>`;
  // }
...
// articlediv.className = "post col-12 col-md-6 sigma_featured-product";
// articlediv.id = "morepicturearticle";
// document.getElementById("morepicture").appendChild(articlediv);

// underdiv = document.createElement("div");
// underdiv.className = "post-thumbnail card";
// underdiv.id = "morepictureunderdiv";
// document.getElementById("morepicturearticle").appendChild(underdiv);

// divimages = document.createElement("img");
// divimages.src = hajos[description].kepek[i];

// divimages.className = " jsimages";
// divimages.id = "morepicturedivimages";
// document.getElementById("morepictureunderdiv").appendChild(divimages);
